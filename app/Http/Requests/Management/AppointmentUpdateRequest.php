...
class AppointmentUpdateRequest extends FormRequest
{
    ...
    {
        return [
            'doctor_schedule_id' => 'sometimes|required|exists:doctor_schedules,id',
            'patient_id' => 'sometimes|required|exists:patients,id',
            'appointment_date' => 'sometimes|required|date_format:Y-m-d H:i:s', // Adjust the format as needed
            'appointment_type' => 'sometimes|required|in:Normal,Follow-Up,Re-Scheduled',
            'appointment_status' => 'sometimes|required|in:Scheduled,Cancelled,Completed',
